...
$reponse = $bdd->query("SELECT p.uid,c.cmdid ,p.nom, p.description, c.qte,p.prix,c.statut FROM commande c INNER JOIN produits p on c.pid=p.pid WHERE c.statut='refusee' AND c.uid=' ".$_SESSION['uid_acheteur']." ' ");
$somme_produit=0;
...
while ($donnees = $reponse->fetch()){ 
  $prix_total=$donnees['qte']*$donnees['prix'];
    ...
    echo"<div class='center' > <h4>Le nombre de Commandes refusees est: $nb_commande </h4> </div>";
